...
class _NewRequestFormSheetState extends State<NewRequestFormSheet> {
  ...
  Widget _buildLabel(String text) {
    return Padding(
      ...
      child: Text(text, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: AppColors.textSecondary, letterSpacing: 1.0)),
    );
  }
  ...
  Widget _buildDropdown(String hint, List<String> items) {
    return DropdownButtonFormField<String>(
      ...
      hint: Text(hint, style: const TextStyle(fontSize: 13, color: AppColors.textTertiary)),
      ...
      children: [
        ...
        Row(
          children: options.map((o) => Row(
            children: [
              Radio<String>(value: o, groupValue: null, onChanged: (_) {}),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(LucideIcons.check, color: Color(0xFF16A34A), size: 28),
            ),
            const SizedBox(height: 16),
            const Text('Solicitud enviada exitosamente', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.textPrimary)),
            const SizedBox(height: 6),
            const Text('Recibirás una respuesta en 3-5 días hábiles.', style: TextStyle(fontSize: 13, color: AppColors.textSecondary)),
          ],
        ),
      );
    }

    final courses = studyPlanCourses.where((c) => c['status'] == 'En curso').map((c) => c['name'] as String).toList();
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              hint: const Text('-- Selecciona un tipo --', style: TextStyle(fontSize: 13)),
              items: _requestTypes.map((t) => DropdownMenuItem(value: t, child: Text(t, style: const TextStyle(fontSize: 13)))).toList(),
              onChanged: (val) => setState(() => _type = val),
            ),
            
            if (_type == "Certificado de Estudios" || _type == "Certificado de Inscripción" || _type == "Certificado de Calificaciones" || _type == "Certificado de Buena Conducta") ...[
              _buildLabel('PROPÓSITO DEL CERTIFICADO'),
              _buildDropdown('Seleccionar...', ['Beca externa', 'Empleo', 'Trámite migratorio', 'Institución bancaria', 'Uso personal', 'Otro']),
            ...
            if (_type == "Revisión de Calificación") ...[
              ...
              _buildDropdown('Seleccionar...', ['Primer parcial', 'Segundo parcial', 'Examen final', 'Tarea / Proyecto']),
              _buildLabel('CALIFICACIÓN RECIBIDA'),
              _buildTextField('Ej: 65'),
              _buildLabel('ARGUMENTO / JUSTIFICACIÓN'),
              _buildTextField('Explica por qué consideras que la nota es incorrecta...', maxLines: 3),
            ],
            ...
            if (_type == "Reporte de Profesor") ...[
              ...
              Row(
                children: [
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [_buildLabel('FECHA'), _buildTextField('YYYY-MM-DD')])),
                  const SizedBox(width: 12),
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [_buildLabel('HORA'), _buildTextField('HH:MM')])),
                ],
              ),
              _buildRadio('¿HUBO TESTIGOS?', ['Sí', 'No']),
              _buildLabel('DESCRIPCIÓN DETALLADA DE LO OCURRIDO'),
              _buildTextField('Describe con detalle lo que ocurrió...', maxLines: 4),
            ],
            ...
            if (_type == "Cambio de Sección") ...[
              ...
              _buildDropdown('Seleccionar...', ['Conflicto de horario laboral', 'Problemas de transporte', 'Razones médicas', 'Preferencia de profesor', 'Otro']),
            ...
            if (_type == "Retiro de Materia") ...[
              ...
              _buildDropdown('Seleccionar...', ['Carga académica alta', 'Problemas económicos', 'Razones de salud', 'Situación familiar', 'Otro']),
              ...
              Container(
                ...
                child: const Text('⚠️ El retiro puede afectar tu índice académico y créditos del semestre. Consulta con tu asesor antes de proceder.', style: TextStyle(fontSize: 11, color: Color(0xFFB45309))),
              ),
            ],
            ...
            if (_type == "Carta de Recomendación") ...[
              ...
              _buildDropdown('Seleccionar...', ['Empleo', 'Maestría / Posgrado', 'Beca', 'Intercambio estudiantil', 'Otro']),
            ...
            if (_type == "Otro") ...[
              ...
              _buildTextField('Describe detalladamente tu solicitud...', maxLines: 5),
            ],
